...
| Behaviour parity | **pass, with a scoped remainder** | Re-characterised control-by-control against the running screens: V2 Study has 39 controls to legacy's 23 and is a superset. Every characterised legacy capability verified present in V2, or belongs to Exams (retained production). One real gap found and fixed: style/granularity were not persisted. Remainder is navigation destinations — the V2 rail still lacks Review Queue, Completed and Profile. See `DECISIONS.md` 2026-08-17. |
